...
## Setup
Multiple scripts are available under [`scripts/`](../../scripts/):
...
- **create_keys.sh**: Creates RSA keys for communication in Vagrant. Injected automatically in Vagrantfile.
